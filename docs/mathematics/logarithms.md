...
This exactly why logarithms of different bases are just different by a constant value.
Because the number of multiplications to reach the number just changes by a constant factor.
:::
