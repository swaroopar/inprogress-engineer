...
The most important mental model is to think in term of **modular** operation which uses the circular based counter.
...
:::danger -x is not geometrical opposite of x
When we look at the number range as a circle, 
the position or value of x isn't geometrically opposite to -x.
:::
