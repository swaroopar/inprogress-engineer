...
| Sum of odd numbers      | $1 + 3 + ... + (2N−1) = {N^2}$                                                           | Explains quadratic growth. Here 2N-1 is the value at each position. Eg., 2×1-1, 2×2-1.                   |
| Sum of even numbers     | $2 + 4 + 8 + ... + 2N = N(N+1)$                                                          | Loops skipping by 2. Here 2N is the value at each position. Eg., 2×1, 2×2.                               |
