...
3. This **Node** is nothing but an implementation of **Entry()** interface.
   It's nothing but the first element of the linked list which is stored in each index of the array.
...
The HashSet() uses a dummy value **PRESENT** as the value in all the **Entry()** object.
