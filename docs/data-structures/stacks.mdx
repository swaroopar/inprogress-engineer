...
<ThemeImage src='/img/stack-data-structure.excalidraw.png' alt='Stack Illustration' />
...
There exists no real stack in the computer.
The stack is just a logical structure that's implemented using arrays or linked lists.

What matters is, the top most address of the stack is **tracked**.
:::
...
There exists no specific size for each frame of the stack.
...
- [**register based language**](../computers/function-calling.mdx#function-call-instructions) -
