...
<ThemeImage src='/img/cpu-cache-lines.excalidraw.png' alt='cpu-cache' />
...
<ThemeImage src='/img/computer-cpu-shared-lines.excalidraw.png' alt='cpu-cache-lines-shared' />
...
<ThemeImage src='/img/cpu-cache-mmu.excalidraw.png' alt='Cache Addressing' />
