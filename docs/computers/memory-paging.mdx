...
<ThemeImage src='/img/memory-paging-implementation.excalidraw.png' alt='memory paging' />
...
<ThemeImage src='/img/computer-memory-pages.excalidraw.png' alt='page table' />
...
<ThemeImage src='/img/page-fault-types.excalidraw.png' alt='page-fault-types' />
...
A good example is, java binary loads itself
...
The memory is still organized into pages.
:::
...
<ThemeImage src='/img/page-fault-handling.excalidraw.png' alt='page fault handler' />

## Segmentation Fault

This is returned by the operating system when invalid access to a memory location occurs.
...
<ThemeImage src='/img/page-swap.excalidraw.png' alt='swapping-oom' />
