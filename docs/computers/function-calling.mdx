...
5. When the next instruction runs,
the if the function is returning any value, then the instruction will definitely be a copy from a specific register back to stack.
