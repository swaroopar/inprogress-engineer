...
to build **MUTEX** solutions by sleeping and waking up threads based on the state of the lock.

1. An application thread calls **Futex** to remove itself out of scheduling until another thread releases the lock.
