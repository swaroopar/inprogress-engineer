...
<ThemeImage src='/img/block-chain.excalidraw.png' alt='block-chain' />
...
**Remember:** If at all the block chain transaction history must store any sensitive data,
...
1. Either you just trust people and systems who adds blocks to the chain.
