...
Still, this is an **optional** field.
...
There exists certain rules to detect which module type is used by a file.
...
Yet it had a different syntax compared to CommonJS.
