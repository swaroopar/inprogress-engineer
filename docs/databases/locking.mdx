...
Locking is a generic concept that can be applied to various domains.
Kernels apply it for [memory](../computers/memory-locking.mdx) and databases apply it for data sets.
:::
...
There exists no checks if the queued updates are making any changes
