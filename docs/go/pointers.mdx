...
In case of Java, the objects aren't really **pass by value**.
...
What's tricky is, \* is used to declare pointer variable and also to access the value at the address.
