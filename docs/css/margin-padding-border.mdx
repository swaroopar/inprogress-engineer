...
Unfortunately this been one of my most confusing topics always.
...
<ThemeImage src='/img/padding-border-margin.excalidraw.png' alt='Diagram' />

:::important Margins Auto Collapse
Both margin and padding helps to add space between elements.
Yet margins between two vertical elements auto collapse.
