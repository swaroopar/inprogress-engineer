...
are just considered as child elements of the physical element to which it's added.
...
<ThemeImage src='/img/pseudo-elements.excalidraw.png' alt='pseudo elements' />
...
the pseudo elements are shown as just a child element with the element name.
...
- [CSS Pseudo Elements: ::before and ::after](https://girlthatlovestocode.com/css-pseudo-elements-before-and-after)
