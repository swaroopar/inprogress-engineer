...
on which the JVM is running. There exists no special handling needed by the developer to handle different platforms.
...
Since JRE contains the JVM and JDK contains JRE, even they become platform dependent.
