...
If the subtraction results in positive value (not just $$+1$$), then first argument comes **after** second.
...
2. Pivot chosen - Always the last element or take any random element and swap that with the last element.
