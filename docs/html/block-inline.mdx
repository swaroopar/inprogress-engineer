...
With CSS, we tweak this normal flow.

<ThemeImage src='/img/html-normal-flow.excalidraw.png' alt='Normal Flow' />
...
We can remember it this way: a parent wraps itself around their child, to show it loves them. :D

Container is just a box, basically, empty until something goes inside it.
