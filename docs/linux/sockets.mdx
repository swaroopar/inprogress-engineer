...
there is just one file descriptor created for a file which is used for both reading and writing.
...
So when a single buffer is used for both reading and writing,
