...
There exists no big distinction between thread and process for the kernel when it comes to executing it.
...
1. Kubelet - it's configured as system service. systemd will fork and then start kubelet program.
