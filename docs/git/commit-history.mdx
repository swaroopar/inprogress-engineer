...
Doing this means, the tree structure will change and there by the commits will change.

New commits will be created with new hashes.
...
For a merge commit, the commits are merged as it is.
...
GIT can readily identify what commits were already merged
