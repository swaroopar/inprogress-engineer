...
ReactDOM library then uses the virtual DOM to generate the actual native HTML for custom components
...
It's important to know that even though every render generates a new virtual DOM,
this doesn't mean that the DOM will be updated.
...
<ThemeImage src='/img/react-render.excalidraw.png' alt='Diagram' />
