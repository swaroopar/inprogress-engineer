...
We see that in [docker containers](./isolation.mdx#container-creation-process),
...
:::info LXC vs Docker
Other than this, Linux and Docker containers are much alike in terms of isolation and resource management.
