...
It's just another [file system](./file-systems) type similar to EXT4.
...
<ThemeImage src='/img/overlay-fs.excalidraw.png' alt='overlay-fs' />
...
Docker creates a new mount namespace and creates this OverlayFS inside that namespace.
:::
